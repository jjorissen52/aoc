...
export const SlowPolymerizer = new CodeRunner((input: string, ...auxInput) => {
  const { steps, showChain, template, rules } = parse_input(input, ...auxInput);
...
export const FastPolymerizer = new CodeRunner((input, ...auxInput) => {
